...
import model.multiscale_transformer_utils as utils
import model.resnet as resnet
from ml_collections.config_dict import ConfigDict

RESNET_TOKEN_DIM = 64

MyDict = {'hidden_size': 384, 'representation_size': None, 'resnet_emb': {'num_layers': 5}
, 'transformer': {'attention_dropout_rate': 0,
  'dropout_rate': 0,
  'mlp_dim': 1152,
  'num_heads': 6,
  'num_layers': 14,
...
class Model(nn.Module):
  ...
  def apply(self,
            ...
            resnet_emb=cfg.get('resnet_emb'),
            representation_size=cfg.get('representation_size')):
