...
def predict_api(image_path):
  model_config, pp_config, params = get_params_and_config("/gpfs/essfs/iat/Tsinghua/liwy/musiq/musiq_ckpts/musiq_spaq_ckpt.npz")
  pred_mos = run_model_single_image(model_config, 1, pp_config,
                                    params, image_path)
  return pred_mos
